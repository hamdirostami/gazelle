 ...
 */
public class PooyaInputTextRenderer extends InputTextRenderer {
    ...
    public void encodeMarkup(FacesContext context, InputText inputText) throws IOException {
        ...
        PooyaInputText input = (PooyaInputText)inputText;
        ...
        if(ComponentTypes.date.equals(input.getComponentType())){
            RequestContext requestContext = RequestContext.getCurrentInstance();
            requestContext.execute("a()");
        }
